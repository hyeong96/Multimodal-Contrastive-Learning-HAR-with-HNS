...
class SimCLRUnimodal(LightningModule):
    def __init__(self, modality, encoder, mlp_in_size, temperature=0.1, batch_size=32, lr=0.001, weight_decay=1e-4, hidden=[256, 128], n_views=2, optimizer_name_ssl='lars', **kwargs) -> None:
        super().__init__()
